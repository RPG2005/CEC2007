    ...
    jQuery.contenteditor = function(element, options) {
        ...
        this.render = function() {
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="color"]').click(function(e) {
                ...
                jQuery('#md-color').css('max-width', '485px');
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="align"]').click(function(e) {
                var savedSel = saveSelection();
                jQuery('#md-align').css('max-width', '200px');
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="list"]').click(function(e) {
                var savedSel = saveSelection();
                jQuery('#md-list').css('max-width', '202px');
            ...
            jQuery('#rte-toolbar a[data-rte-cmd="icon"]').unbind('click');
            jQuery('#rte-toolbar a[data-rte-cmd="icon"]').click(function(e) {
        ...
        this.init = function() {
            ...
            $element.hover(function(e) {
                ...
                if (cb_edit && !fixedimage) {
                    jQuery("#divToolImg").css("top", _top-175 + "px");
                    jQuery("#divToolImg").css("left", _left-275 + "px");
                    ...
                    if (jQuery(this).data("imageembed").settings.linkDialog) {
                        jQuery("#divToolImgSettings").css("top", _top2-175 + "px");
                        jQuery("#divToolImgSettings").css("left", _left-275 + "px");
