<?php
    include 'includes/class/NavbarClass.php';
    $navbarphpfilenameactive = basename($_SERVER['PHP_SELF']);

    $navabar01 = new Navbar($navbarphpfilenameactive);

    $uno = $navabar01->navbarname();
    echo $navabar01->navbarname . " ---- " .$uno . " --- ";
